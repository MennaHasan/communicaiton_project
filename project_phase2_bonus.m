...
% Comm II project phase 2 bonus May, 2022


% for the bonus part, the same code is repeated on the file "bonus.txt"
% results from trying the algorithm on a different file are very similar to
% the ones obtained in the main file. This proves the effeciency of the
% Huffman code is independent of the text
...
% results:
% total length in Huffman encoding = 9392
% total length when equal number of bits for each character is used = 12528
...
% the entropy = 4.4748
% the effeciency of huffman encoding = 0.9948
% the effeciency of encoding with equal number of bits = 0.7458
